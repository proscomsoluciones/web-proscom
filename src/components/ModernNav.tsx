...
const ModernNav = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full bg-white/90 backdrop-blur-md border-b border-gray-100 py-1">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          {/* Logo */}
          <div className="flex-shrink-0 flex items-center">
            <Link href="/" className="py-2 flex items-center">
              <ProscomLogo variant="dark" />
            </Link>
          </div>

          {/* Navigation Links (Desktop Center) */}
          <div className="hidden lg:flex space-x-8 items-center">
            <Link href="/#servicios" className="text-sm font-semibold text-gray-700 hover:text-[#002B5B] transition-colors">
              Soluciones
            </Link>
            <Link href="/#ciberseguridad" className="text-sm font-semibold text-gray-700 hover:text-[#002B5B] transition-colors">
              Ciberseguridad
            </Link>
            <Link href="/#latam" className="text-sm font-semibold text-gray-700 hover:text-[#002B5B] transition-colors">
              Presencia Latam
            </Link>
            <Link href="/nosotros" className="text-sm font-semibold text-gray-700 hover:text-[#002B5B] transition-colors">
              Nosotros
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center gap-5">
            <Link 
              href="/#contacto"
              className="inline-flex items-center px-5 py-2.5 text-sm font-bold rounded-xl text-white bg-[#002B5B] hover:bg-[#001D3D] transition-all shadow-sm"
            >
              Consultoría Corporativa
            </Link>
            
            <div className="flex items-center gap-3 border-l border-gray-200 pl-4 h-6">
              <a 
                href="https://www.instagram.com/proscom.cl/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-[#002B5B] hover:text-blue-600 transition-all hover:scale-110"
      ...
      {isOpen && (
        <div className="md:hidden bg-white border-b border-gray-100 animate-in slide-in-from-top duration-300">
          <div className="px-6 pt-2 pb-8 space-y-4">
            <Link href="/#servicios" className="block text-lg font-bold text-gray-800" onClick={() => setIsOpen(false)}>Soluciones Corporativas</Link>
            <Link href="/#ciberseguridad" className="block text-lg font-bold text-gray-800" onClick={() => setIsOpen(false)}>Ciberseguridad</Link>
            <Link href="/#latam" className="block text-lg font-bold text-gray-800" onClick={() => setIsOpen(false)}>Presencia Latam</Link>
            ...
            <Link 
              href="/#contacto"
              className="block w-full text-center py-4 bg-[#002B5B] text-white font-bold rounded-xl shadow-md"
